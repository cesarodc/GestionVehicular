...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="form-inline my-2 my-lg-0">
        ...
        <button class="btn btn-info my-2 my-sm-0" style="padding: 7px;" type="button" onclick="location.href='Inicio-ADMIN.php'">Usuarios</button>
        &nbsp;
        &nbsp;
        <button class="btn btn-warning my-2 my-sm-0" style="padding: 7px;" type="button" onclick="location.href='Sanciones.php'">Sanciones</button>
        &nbsp;
        &nbsp;
  ...
  <!-- Lógica del Frontend -->
  <script src="assets/js/app_buzon.js"></script>
</body>
<hr color="white">
